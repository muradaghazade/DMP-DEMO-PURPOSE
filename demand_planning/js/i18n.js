...
(function () {
    ...
    const EXACT = {
        ...
        'Added to cart': 'Səbətə əlavə edildi',
        'Clear cart': 'Səbəti təmizlə',
        'Create RFX with shopping cart': 'Səbətdəki məhsullarla RFX yarat',
        ...
        'Mandatory for OEM · not listed? Type the name and add it': 'OEM üçün məcburidir · siyahıda yoxdur? Adı yazın və əlavə edin',
        'Model / series of the item': 'Məhsulun modeli / seriyası',
        'Locations of the first selected plant': 'İlk seçilmiş zavodun yerləri',
        'All categories': 'Bütün kateqoriyalar',
        'All manufacturers': 'Bütün istehsalçılar',
        'All items': 'Bütün elementlər',
        'Valuation class missing': 'Qiymətləndirmə sinfi yoxdur',
        'Valuation class set': 'Qiymətləndirmə sinfi təyin edilib',
        'PO unit missing': 'PO vahidi yoxdur',
        'PO unit set': 'PO vahidi təyin edilib',
        'Material group missing': 'Material qrupu yoxdur',
        'Material group set': 'Material qrupu təyin edilib',
        'Inventory data missing': 'İnventar məlumatı yoxdur',
        'Inventory data set': 'İnventar məlumatı təyin edilib',
        'Apply to shown items': 'Göstərilən elementlərə tətbiq et',
        'Set up shown items (': 'Göstərilən elementləri qur (',
        'Applies to the items the filters show. You can still adjust single items below.': 'Filtrlərin göstərdiyi elementlərə tətbiq olunur. Aşağıda tək elementləri hələ də dəyişə bilərsiniz.',
        'No attribute schema for this category.': 'Bu kateqoriya üçün atribut sxemi yoxdur.',
        'Type a value, press Enter': 'Dəyər yazın, Enter basın',
        'Submitting to the AI engine…': 'AI mühərrikinə göndərilir…',
        'Could not classify': 'Təsnif edilə bilmədi',
        'The AI could not match this item to any category in the system. Please submit a new-category request with the AI-identified category:': 'AI bu məhsulu sistemdəki heç bir kateqoriyaya uyğunlaşdıra bilmədi. Zəhmət olmasa AI-nin müəyyən etdiyi kateqoriya ilə yeni kateqoriya sorğusu göndərin:',
        'The Central team must approve it before the item can be created.': 'Məhsul yaradılmazdan əvvəl Mərkəzi komanda onu təsdiq etməlidir.',
        'The AI engine did not return a category proposal for this description. Create a new-category request manually — the Central team will review it before the item can be created.': 'AI mühərriki bu təsvir üçün kateqoriya təklifi qaytarmadı. Yeni kateqoriya sorğusunu əl ilə yaradın — məhsul yaradılmazdan əvvəl Mərkəzi komanda onu nəzərdən keçirəcək.',
        'could not classify': 'təsnif edilə bilmədi',
        'Could not read the file': 'Fayl oxuna bilmədi',
        'No descriptions found': 'Təsvir tapılmadı',
        'Process with AI engine': 'AI mühərriki ilə emal et',
        'Request submitted': 'Sorğu göndərildi',
        'Submit request': 'Sorğunu göndər',
        'Waiting for the engine to accept the job…': 'Mühərrikin işi qəbul etməsi gözlənilir…',
        'Review the description and try a single search': 'Təsviri yoxlayın və tək axtarışla yenidən cəhd edin',
        'Processed by the live AI engine': 'Canlı AI mühərriki tərəfindən emal edildi',
        'Live AI unavailable': 'Canlı AI əlçatan deyil',
        'Analysed with the built-in engine instead.': 'Əvəzində daxili mühərriklə təhlil edildi.',
        'Verified on the web': 'Vebdə yoxlanılıb',
        'List attributes need at least one value.': 'List tipli atributlar üçün ən azı bir dəyər tələb olunur.',
        'Values are defined for List fields only': 'Dəyərlər yalnız List tipli sahələr üçün müəyyən edilir',
        'Select manufacturer…': 'İstehsalçı seçin…',
        'Manufacturer added': 'İstehsalçı əlavə edildi',
    ...
    const PATTERNS = [
        ...
        [/^(\d+) mandatory field\(s\) must be completed before approving\.$/, 'Təsdiq etməzdən əvvəl $1 məcburi sahə doldurulmalıdır.'],
        [/^(.*) · Plant (\S+)$/, '$1 · Zavod $2'],
        [/^Plant (\d+)$/, 'Zavod $1'],
        ...
        [/^\+ Add “(.+)”$/, '+ “$1” əlavə et'],
        [/^(.+) — current value$/, '$1 — cari dəyər'],
        [/^AI pipeline running — (\d+)s…$/, 'AI emal davam edir — $1 san…'],
        [/^AI pipeline running — (\d+) of (\d+) item\(s\) processed \((\d+)%\)…$/, 'AI emal davam edir — $2 elementdən $1 emal edildi ($3%)…'],
        [/^Submitted to the live AI engine( · est\. \$([\d.]+))?$/, 'Canlı AI mühərrikinə göndərildi$1'],
        [/^Submitted — Request # (\d+)$/, 'Göndərildi — Sorğu № $1'],
        [/^“(.+)” is now in the manufacturer master data\.$/, '“$1” artıq istehsalçı əsas məlumatlarındadır.']
    ];
